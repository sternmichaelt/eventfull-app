          ...
          <div className="pb-6">
            {yearGroups.map((group) => (
              <div key={group.year} id={`events-year-${group.year}`}>
                <div className="sticky top-0 z-10 bg-slate-50/95 backdrop-blur-sm border-y border-slate-200 px-4 md:px-6 py-2">
                    ...
                    return (
                      <li key={event.id}>
                        <div
                          ...
                          className="flex items-stretch gap-3 md:gap-4 px-4 md:px-6 py-3 cursor-pointer hover:bg-slate-50 transition-colors group"
                        >
                          <div
...
export default AllEventsListView;
