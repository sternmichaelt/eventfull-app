-- Complete Fix: Ensure all user_id columns are TEXT and constraints are removed
-- Run this if the migration didn't work or if you need to fix the schema
...
-- 4. Photos table (may already be TEXT)
